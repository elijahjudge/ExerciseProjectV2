<template>
  <div class="Profile">
    ...
    <div class="headerContainer">
      <h1 class="title" align="center" style ="font-size:65px ; color:rgb(83, 50, 180) "  >
        Profile
      </h1>
    </div>
    ...
    <form class="profileContainer" id="profileForm">
      ...
      <div class="sectionContainer">
        ...
        <div class="inputLine" id="activity">
          <div class="part-label">Exercise Goals</div>
          ...
          <select class="input-box section-end form-control" id="weightGoals">
            ...
            <option value="500">mental health benefits</option>
            <option value="-1000">general physical benefits</option>
          </select>
        </div>
...
.Profile .profileContainer .submitBtn {
  ...
  font-size: 20px;
  font-weight: bold;
  background-color: rgb(83, 50, 180);
  color:white;
  width: 500px;
  height: 50px;
